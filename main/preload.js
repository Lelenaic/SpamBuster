...
// General settings API (scheduler, AI sensitivity, email age, simplify content, date format)
contextBridge.exposeInMainWorld("generalAPI", {
    getAISensitivity: () => ipcRenderer.invoke('general:getAISensitivity'),
    setAISensitivity: (value) => ipcRenderer.invoke('general:setAISensitivity', value),
    getEmailAgeDays: () => ipcRenderer.invoke('general:getEmailAgeDays'),
    setEmailAgeDays: (value) => ipcRenderer.invoke('general:setEmailAgeDays', value),
    getSimplifyEmailContent: () => ipcRenderer.invoke('general:getSimplifyEmailContent'),
    setSimplifyEmailContent: (value) => ipcRenderer.invoke('general:setSimplifyEmailContent', value),
    getSimplifyEmailContentMode: () => ipcRenderer.invoke('general:getSimplifyEmailContentMode'),
    setSimplifyEmailContentMode: (value) => ipcRenderer.invoke('general:setSimplifyEmailContentMode', value),
    getEnableCron: () => ipcRenderer.invoke('general:getEnableCron'),
    setEnableCron: (value) => ipcRenderer.invoke('general:setEnableCron', value),
    getCronExpression: () => ipcRenderer.invoke('general:getCronExpression'),
    setCronExpression: (value) => ipcRenderer.invoke('general:setCronExpression', value),
    validateCronExpression: (expression) => ipcRenderer.invoke('general:validateCronExpression', expression),
    getSchedulerMode: () => ipcRenderer.invoke('general:getSchedulerMode'),
    setSchedulerMode: (value) => ipcRenderer.invoke('general:setSchedulerMode', value),
    getSchedulerSimpleValue: () => ipcRenderer.invoke('general:getSchedulerSimpleValue'),
    setSchedulerSimpleValue: (value) => ipcRenderer.invoke('general:setSchedulerSimpleValue', value),
    getSchedulerSimpleUnit: () => ipcRenderer.invoke('general:getSchedulerSimpleUnit'),
    setSchedulerSimpleUnit: (value) => ipcRenderer.invoke('general:setSchedulerSimpleUnit', value),
    generateCronFromSimple: (value, unit) => ipcRenderer.invoke('general:generateCronFromSimple', value, unit),
    getDateFormat: () => ipcRenderer.invoke('general:getDateFormat'),
    setDateFormat: (value) => ipcRenderer.invoke('general:setDateFormat', value),
    getCustomDateFormat: () => ipcRenderer.invoke('general:getCustomDateFormat'),
    setCustomDateFormat: (value) => ipcRenderer.invoke('general:setCustomDateFormat', value),
    getTimeFormat: () => ipcRenderer.invoke('general:getTimeFormat'),
    setTimeFormat: (value) => ipcRenderer.invoke('general:setTimeFormat', value),
});
